...
export default function RegisterForm() {
  ...
  const cbUserAgreedOnChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        ...
        <div>
          <input
            className={"me-2 form-check-input" + (genderError ? " is-danger" : "")}
            type="radio"
          ...
          Male 👨
          <input
            className={"mx-2 form-check-input"+ (genderError ? " is-danger" : "")}
            type="radio"
